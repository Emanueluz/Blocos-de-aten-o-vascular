...
class Config:
    ...
    test_images_dir = '/home/emanuel/Documentos/mestrado/bases de dados/FIVES/PDI_puro/test/verde_clahe'
    ...
    n_runs = 5
    save_results = True
    results_dir = './results-verde_clahe'
    model_name = 'ViTUNet_verde_clahe'
...
# ============================================
# MODELO ViTUNet MODIFICADO PARA GRAYSCALE
# ============================================
class ViTUNet(nn.Module):
    def __init__(self, num_classes=1, pretrained=True, img_size=224, input_channels=1):
        ...
        # Posicionamento adaptado para ViT
