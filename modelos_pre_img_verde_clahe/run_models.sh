...
# Configurações
BASE_DIR="/home/emanuel/Documentos/mestrado/treino dos modelos/modelos_pre_img_verde_clahe"
MODELOS=(
    "five_efficientNet_canal_verde_clahe.py"
    "five_mobileNetV2net_canal_verde_clahe.py"
    "five_resnet101_canal_verde_clahe.py"
    "five_swin_canal_verde_clahe.py"
    "five_vgg19_canal_verde_clahe.py"
    "five_vit_canal_verde_clahe.py"
)
