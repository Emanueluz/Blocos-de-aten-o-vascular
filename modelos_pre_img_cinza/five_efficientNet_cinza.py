...
# -*- coding: utf-8 -*-
"""
Segmentação de Vasos em Fundoscopia - EfficientNetB0 UNet (Grayscale)
...
class Config:
    def __init__(self, args):
        ...
        self.best_model_path = './best_EfficientNetB0UNet_grayscale.pth'
...
# ============================================
# MODELO EfficientNetB0 UNet para GRAYSCALE
# ============================================
...
def test_model_average_detailed(config):
    ...
    for dataset_info in config.test_datasets:
        ...
        for run_id in range(config.n_runs):
            ...
            model = EfficientNetB0UNet(num_classes=1, pretrained=False, input_channels=input_channels)
            model_path = os.path.join(config.models_dir, f'best_model_run_{run_id}.pth')
...
# ============================================
def parse_args():
    parser = argparse.ArgumentParser(description='EfficientNetB0 UNet para Segmentacao de Vasos em Fundoscopia (Grayscale)')
    ...
    parser.add_argument('--model_name', type=str, default='EfficientNetB0_UNet_Grayscale', help='Nome do modelo (padrao: EfficientNetB0_UNet_Grayscale)')
