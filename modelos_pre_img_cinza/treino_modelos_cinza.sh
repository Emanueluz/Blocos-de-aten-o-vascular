...
# Configurações
BASE_DIR="/home/emanuel/Documentos/mestrado/treino dos modelos/modelos_pre_img_cinza/"
MODELOS=(
    "five_efficientNet_cinza.py"
    "five_mobileNetV2net_cinza.py"
    "five_resnet101_cinza.py"
    "five_swin_cinza.py"
    "five_vgg19_cinza.py"
    "five_vit_cinza.py"
)
