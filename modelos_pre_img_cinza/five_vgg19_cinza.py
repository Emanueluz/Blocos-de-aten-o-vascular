    ...
    def __init__(self, args):
        ...
        for test_dir in args.test_dirs:
            ...
            if ':' in test_dir:
                ...
                dataset_name = os.path.basename(os.path.normpath(images_path))
            else:
...
def parse_args():
    ...
    parser.add_argument('--test_dirs', nargs='+', required=True,
                        help='Diretorios das bases de teste. Formatos aceitos: /path/to/base (deteccao automatica) ou /path/imagens:/path/mascaras')
    ...
    parser.add_argument('--model_name', type=str, default='VGG19_UNet_Grayscale')
