...
# -*- coding: utf-8 -*-
"""
Segmentação de Vasos em Fundoscopia - MobileNetV2 UNet (Grayscale)
...
class Config:
    def __init__(self, args):
        ...
        self.best_model_path = './best_MobileNetV2UNet_grayscale.pth'
...
# ============================================
# MODELO MobileNetV2UNet para GRAYSCALE
# ============================================
