...
# Configurações
BASE_DIR="/home/emanuel/Documentos/mestrado/treino dos modelos/modelos_pre_img_green/"
MODELOS=(
    "five_efficientNet_canal_G.py"
    "five_mobileNetV2net_canal_G.py"
    "five_resnet101_canal_G.py"
    "five_swin_canal_G.py"
    "five_vgg19_canal_G.py"
    "five_vit_canal_G.py"
)
