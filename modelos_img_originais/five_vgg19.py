...
# -*- coding: utf-8 -*-
"""
Segmentação de Vasos em Fundoscopia - VGG19 UNet (RGB)
...
class Config:
    def __init__(self, args):
        ...
        self.best_model_path = './best_vgg19_segmentation.pth'
...
# ============================================
def parse_args():
    parser = argparse.ArgumentParser(description='VGG19 UNet para Segmentacao de Vasos em Fundoscopia')
    ...
    parser.add_argument('--model_name', type=str, default='VGG19_UNet', help='Nome do modelo (padrao: VGG19_UNet)')
...
def main():
    ...
    for run_id in range(config.n_runs):
        ...
        try:
            model = VGG19UNet(num_classes=config.num_classes, pretrained=config.pretrained)
            model = model.to(config.device)
