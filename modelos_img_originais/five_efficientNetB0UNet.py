...
# -*- coding: utf-8 -*-
"""
Segmentação de Vasos em Fundoscopia - EfficientNetB0 UNet (RGB)
...
class Config:
    def __init__(self, args):
        ...
        self.best_model_path = './best_EfficientNetB0UNet_segmentation.pth'
...
# ============================================
# MODELO EfficientNetB0 UNet (RGB) - BASE FUNCIONANDO
# ============================================
...
# ============================================
def parse_args():
    parser = argparse.ArgumentParser(description='EfficientNetB0 UNet para Segmentacao de Vasos em Fundoscopia')
    ...
    parser.add_argument('--model_name', type=str, default='EfficientNetB0_UNet', help='Nome do modelo (padrao: EfficientNetB0_UNet)')
