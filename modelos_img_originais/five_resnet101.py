...
def visualize_results(config):
    ...
    summary_path = os.path.join(experiment_dir, 'run_0', 'run_summary.csv')
    if os.path.exists(summary_path):
        # Tentar carregar todos os summaries
        all_summaries = []
        for run_id in range(config.n_runs):
            run_summary_path = os.path.join(experiment_dir, f'run_{run_id}', 'run_summary.csv')
