...
# -*- coding: utf-8 -*-
"""
Segmentação de Vasos em Fundoscopia - SwinUNet (RGB)
...
class Config:
    def __init__(self, args):
        ...
        self.best_model_path = './best_SwinUNet_segmentation.pth'
...
# ============================================
def parse_args():
    parser = argparse.ArgumentParser(description='SwinUNet para Segmentacao de Vasos em Fundoscopia')
    ...
    parser.add_argument('--batch_size', type=int, default=4, help='Batch size (padrao: 4)')
    ...
    parser.add_argument('--model_name', type=str, default='SwinUNet', help='Nome do modelo (padrao: SwinUNet)')
