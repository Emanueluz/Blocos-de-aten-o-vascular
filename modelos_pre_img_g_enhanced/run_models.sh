...
# Configurações
BASE_DIR="/home/emanuel/Documentos/mestrado/treino dos modelos/modelos_pre_img_g_enhanced"
MODELOS=(
    "five_efficientNet_canal_g_enhanced.py"
    "five_mobileNetV2net_canal_g_enhanced.py"
    "five_resnet101_canal_g_enhanced.py"
    "five_swin_canal_g_enhanced.py"
    "five_vgg19_canal_g_enhanced.py"
    "five_vit_canal_g_enhanced.py"
)
